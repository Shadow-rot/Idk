...
def get_gif(key: str) -> str:
    ...
    gifs = CINEMATIC_GIFS.get(key, CINEMATIC_GIFS['portal'])
...
async def send_animated_message(context: CallbackContext, chat_id: int, text: str, gif_url: str = None, reply_to_message_id: int = None, reply_markup=None):
...
async def start_wizard(update: Update, context: CallbackContext):
    ...
    keyboard = InlineKeyboardMarkup([
        [
            ...
            InlineKeyboardButton("📜 ꜱᴘᴇʟʟʙᴏᴏᴋ", callback_data="menu:spells")
        ],
        [
            InlineKeyboardButton("💰 ᴇɴᴛᴇʀ ꜱʜᴏᴘ", callback_data="menu:shop"),
            InlineKeyboardButton("🎒 ɪɴᴠᴇɴᴛᴏʀʏ", callback_data="menu:inventory")
        ],
        [
            InlineKeyboardButton("⚔️ ᴅᴜᴇʟ ᴀʀᴇɴᴀ", callback_data="menu:duel"),
            InlineKeyboardButton("🏆 ʀᴀɴᴋɪɴɢꜱ", callback_data="menu:rank")
        ],
        [
            InlineKeyboardButton("🎁 ᴅᴀɪʟʏ ʀᴇᴡᴀʀᴅ", callback_data="menu:daily"),
