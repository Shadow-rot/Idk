...
# Register handlers 
application.add_handler(CommandHandler("luv", luv, block=False)) 
application.add_handler(CommandHandler("luvstats", luv_stats, block=False)) 
application.add_handler(CommandHandler("luvhelp", luv_help, block=False)) 
application.add_handler(CommandHandler("luvview", luv_view, block=False)) 
application.add_handler(CommandHandler("luvconfig", luv_config, block=False)) 
application.add_handler(CommandHandler("luvrarity", luv_rarity, block=False)) 
application.add_handler(CommandHandler("luvrmrarity", luv_rmrarity, block=False)) 
application.add_handler(CommandHandler("luvreset", luv_reset, block=False)) 
